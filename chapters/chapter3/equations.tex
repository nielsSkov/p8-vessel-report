...
\begin{where}
    ...
    \va{F_{1,2}}{are the forces applied by each thuster}{N}
\end{where}
...
\begin{where}
    ...
    \va{l_1}{is the perpendicular distance from thruster 1 to the center of gravity}{m}
    \va{l_2}{is the perpendicular distance from thruster 2 to the center of gravity}{m}
\end{where}
