...
The added mass induces forces that originate from the vessel imposing some energy in the surrounding fluid when it moves through it. The force generated is dependent on the acceleration of the vessel. \fxnote{what to do here?? Maybe say that we used the masss of the boat and we neglect the added mass effect}
