...
A surface vessel is provided for the project. As seen on \fxnote{ref to photo of boat}, the boat is equipped with actuators, censoring and control electronics. The subsystems used are indicated on the figure.
...
This chapter briefly describes the main components of the surface vessel used in this project. Some additions to the existing systems are also presented.\fxnote{this aauship source seems out of place, where should it have been?} \cite{aauship}
