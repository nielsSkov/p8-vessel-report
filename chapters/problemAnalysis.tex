...
%%%%%Precision%%%%%%%%%%%
Following the S-44 IHO standards for hydrographic mapping, the measurements fall into the special category, which sets a maximum allowable horizontal total horizontal unceartanty (THU) of 2 m, 95\% confidence level for the positional measurements. 
