...
It have been decided to use this standard as this is the one that best resembles the intended use case of the system. \cite{CHS} \fxnote{this standard is for measurements, what should be say about controller requirements?}
