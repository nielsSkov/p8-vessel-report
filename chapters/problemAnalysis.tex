...
From initial meetings with project supervisor, Jesper Abilgaard Larsen it was stated that a minimum of 30cm is required for the barometric measurements to be usable.\fxnote{Working on how to source this maybe use minutes?}
...
As illustrated on \autoref{fig:boatdist}, these external forces would alter the force vector of the boat, influencing it's trajectory. 
