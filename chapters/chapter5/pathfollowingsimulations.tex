...
The straight path limits are also included to show the parts of the path where it is important to be closed to the line. It can be seen that both nominal responses and the 1-$\sigma$ regions are below the 30 cm requirement, whereas some of the extreme curves go beyond that line.
