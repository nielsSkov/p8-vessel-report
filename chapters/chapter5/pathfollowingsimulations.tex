\section{Simulation Results}\label{sec:pathSim}
...
In this case, the offset in position has been corrected and the path is followed within the desired precision in the straight line segments. There are still some small deviations due to the wave disturbance present in the system, but the 1-$\sigma$ value is under 10 cm and the maximum variations stay below 15 cm with respect to the reference path.
