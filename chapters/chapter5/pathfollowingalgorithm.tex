...
For this particular system, and considering that the bandwidth of the LQR is \num{1.5} rad s$^{-1}$, a radius of \num{2} m is chosen as this gives settling time of 15 s and a bandwidth of \num{0.2} rad s$^{-1}$, seven times slower than the inner controller. For the $\mathcal{H}_\infty$ Controller, the bandwidth is \num{0.6} rad s$^{-1}$, so the radius is chosen to be \num{4.5} m, giving a bandwidth of \num{0.085} rad s$^{-1}$.
