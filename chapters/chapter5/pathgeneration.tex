...
%
\begin{where}
  \va{x_\mathrm{start}}{is the starting x coordinate}{m}
  \va{y_\mathrm{start}}{is the starting y coordinate}{m}
  \va{x_\mathrm{end}}{is the ending x coordinate}{m}
  \va{y_\mathrm{end}}{is the ending y coordinate}{m}
\end{where}
